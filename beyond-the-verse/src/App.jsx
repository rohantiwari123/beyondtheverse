...
export default function App() {
  ...
  const { isAuthenticated, isAdmin, isTeacher, isExaminer } = useAuth();
        ...
        <Suspense fallback={<PageLoader />}>
          <div key={location.pathname} className="page-fade-in">
            <Routes location={location}>
              ...
              <Route path="/profile" element={isAuthenticated ? <ProfilePage showToast={showToast} /> : <Navigate to="/login" />} />
              <Route path="/profile/:id" element={<ProfilePage showToast={showToast} />} />
              <Route path="/settings" element={isAuthenticated ? <SettingsPage showToast={showToast} /> : <Navigate to="/login" />} />
              ...
              {/* RESTRICTED: Admin/Teacher/Examiner Route */}
