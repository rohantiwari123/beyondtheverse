  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start transition-colors">
      ...
      <div className="space-y-5">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl text-slate-800 font-cabinet font-black tracking-tight">
      ...
      {/* The Solution Box */}
      <div className="bg-slate-50 p-8 sm:p-10 rounded-2xl border border-slate-200 transition-colors">
        <h3 className="text-xl sm:text-2xl text-slate-800 mb-4 flex items-center gap-3 font-bold tracking-tight">
