...
export default function LibraryEmptyState({ openModal }) {
  return (
    <div className="mx-4 sm:mx-0 py-24 sm:py-32 flex flex-col items-center justify-center border border-dashed border-slate-300 bg-slate-50/50 rounded-2xl sm:rounded-[2rem]">
      ...
      <p className="text-slate-500 text-sm sm:text-base mb-8 text-center max-w-xs">Get started by creating a new folder or uploading your first document.</p>
